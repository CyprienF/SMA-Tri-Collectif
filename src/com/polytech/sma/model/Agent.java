...
public class Agent{
    ...
    /*
    public ArrayList<Movement> getPossibleMovement(Environement g){
    ...
    public ArrayList<Movement> getMovementFreeSlot(Environement g, ArrayList<Movement> possibleMovement) {
